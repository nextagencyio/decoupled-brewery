...
export const metadata: Metadata = {
  title: 'Events | Blackstone Brewing Co.',
...
async function getEvents() {
  try {
    ...
    const { data } = await apolloClient.query<EventData>({
      query: GET_EVENTS,
      variables: { first: 50 },
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center pt-16">
            ...
            <p className="text-xl text-amber-200/60 max-w-3xl mx-auto">
              Join us for tastings, live music, and more.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {items.length === 0 ? (
            <div className="text-center py-12">
              <h2 className="text-2xl font-semibold text-amber-200/60 mb-2">No Events Yet</h2>
