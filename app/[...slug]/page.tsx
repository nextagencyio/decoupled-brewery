  ...
  return (
    <div className="text-center py-16">
      <div className="bg-primary-900 border border-primary-800 rounded-lg p-12">
        ...
        <p className="text-amber-200/60 mb-2">We couldn&#39;t find any content at this path.</p>
        <p className="text-sm text-amber-200/40">Path: {path}</p>
      </div>
    </div>
  )
}
          ...
          <ErrorBoundary>
            <article className="bg-primary-900 border border-primary-800 rounded-lg shadow-sm overflow-hidden">
              ...
              <div className="p-6 md:p-8">
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display font-light text-white mb-4 md:mb-6">{title}</h1>
                <div className="prose prose-invert prose-headings:text-white prose-p:text-amber-200/70 prose-a:text-accent-400 prose-strong:text-white prose-sm sm:prose lg:prose-lg max-w-none" dangerouslySetInnerHTML={{ __html: bodyHtml }} />
              </div>
            </article>
          </ErrorBoundary>
        </main>
